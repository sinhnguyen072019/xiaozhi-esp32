...
void LcdDisplay::SetupUI() {
    ...
    lv_obj_set_style_text_color(sensor_label_, lvgl_theme->text_color(), 0);
    lv_obj_set_style_margin_left(sensor_label_, lvgl_theme->spacing(2), 0);
    ...
    lv_obj_set_size(notification_label_, LV_HOR_RES * 0.7, 18);
    ...
    lv_obj_set_size(status_label_, LV_HOR_RES * 0.7, 18);
